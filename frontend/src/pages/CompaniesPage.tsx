...
export function CompaniesPage() {
  ...
  const [companyView, setCompanyView] = useState<"painel" | "cadastro">("painel");
    ...
    <section className="page-grid">
      <article className="card">
        <div className="section-heading">
          ...
          <p className="section-copy">
            Use a lista para abrir uma conta e enxergar rapidamente pessoas, leads e oportunidades relacionados.
          </p>
        </div>
      ...
      <article className="card">
        <div className="panel-switcher">
          <button
            className={companyView === "painel" ? "ghost-button active-toggle" : "ghost-button"}
            onClick={() => setCompanyView("painel")}
            type="button"
          >
            Painel da conta
          </button>
          <button
            className={companyView === "cadastro" ? "ghost-button active-toggle" : "ghost-button"}
            onClick={() => setCompanyView("cadastro")}
            type="button"
          >
            Cadastro
          </button>
          ...
          selectedCompany ? (
            <div className="detail-panel detail-panel-standalone">
              <div className="detail-hero">
                ...
                <div className="section-heading">
                  <span className="eyebrow">Conta em foco</span>
            ...
            <div className="empty-state-panel">
              <strong>Selecione uma empresa na lista</strong>
